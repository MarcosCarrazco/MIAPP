...
class PastorWidget extends StatefulWidget {
  const PastorWidget({Key key}) : super(key: key);

  @override
  _PastorWidgetState createState() => _PastorWidgetState();
}

class _PastorWidgetState extends State<PastorWidget> {
