...
class HawaianaWidget extends StatefulWidget {
  const HawaianaWidget({Key key}) : super(key: key);

  @override
  _HawaianaWidgetState createState() => _HawaianaWidgetState();
}

class _HawaianaWidgetState extends State<HawaianaWidget> {
